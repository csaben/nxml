...
def default_end_screen_path() -> Path:
    ...
    Seeded by ``nxml-coplay``'s default Triggers on first launch.
    """
...
# Debounce stays at coplay's default 1.0 s (anti-flicker).
#
...
def default_triggers() -> list[DefaultTriggerSeed]:
    """Return the trigger specs seeded into an empty coplay trigger store."""
    return [
        {
            "name": "end_screen",
        ...
        },
        {
            ...
            # nxml_coplay.triggers (256x128, (52, 38, 204, 90)); leave
