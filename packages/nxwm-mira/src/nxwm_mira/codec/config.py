...
class RAEEncoderConfig(BaseModel):
    ...
    # How preprocessing fits source frames to the target aspect ratio. "pad" (MIRA's behavior,
    # kept as the default for checkpoint compat) letterboxes with black before resizing;
    # "stretch" resizes anisotropically — correct for the ZA corpus, whose 16:9 content is
    # stored anamorphically squashed into 4:3 frames.
    aspect_mode: Literal["pad", "stretch"] = "pad"
