...
from .metrics import DistributedMetric
...
class TrainingTracker:
    ...
    def on_batch_processed(self, batch: VideoBatch, losses: dict[str, torch.Tensor]) -> None:
    ...
    def get_stats(self, step: int) -> dict[str, float]:
        ...
        if self.total_steps is not None and step > 0 and self.training_start_time is not None:
...
class display_execution_time:  # noqa: N801 -- mira-ported API name
